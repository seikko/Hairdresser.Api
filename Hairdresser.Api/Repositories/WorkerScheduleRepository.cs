...
{
    public class WorkerScheduleRepository : Repository<WorkerSchedule>, IWorkerScheduleRepository
    {
        public WorkerScheduleRepository(ApplicationDbContext context) : base(context)
        {
        }
